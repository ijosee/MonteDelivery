...
const RESTAURANTS = [
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1515443961218-a51367888e4b?w=600&h=400&fit=crop&q=80',
  ...
  },
  {
    ...
    imageUrl: 'https://images.unsplash.com/photo-1598103442097-8b74394b95c6?w=600&h=400&fit=crop&q=80',
    cuisineType: 'pollos',
    deliveryFeeEur: 1.00,
    minOrderEur: 8.00,
...
const PRODUCTS_BY_RESTAURANT: Record<number, ProductDef[]> = {
  0: [ // Hamburguesería Sa Plaça
    { categoryName: 'Entrantes', name: 'Nachos con queso', description: 'Nachos crujientes con queso cheddar fundido', priceEur: 5.50, imageUrl: 'https://images.unsplash.com/photo-1513456852971-30c0b8199d4d?w=600&h=400&fit=crop&q=80', allergenIds: [1, 7] },
    { categoryName: 'Entrantes', name: 'Aros de cebolla', description: 'Aros de cebolla rebozados y crujientes', priceEur: 4.50, imageUrl: 'https://images.unsplash.com/photo-1639024471283-03518883512d?w=600&h=400&fit=crop&q=80', allergenIds: [1, 3] },
    { categoryName: 'Principales', name: 'Burger Clásica', description: 'Hamburguesa de ternera con lechuga, tomate y cebolla', priceEur: 8.50, imageUrl: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&h=400&fit=crop&q=80', allergenIds: [1, 3, 7, 10, 11] },
    { categoryName: 'Principales', name: 'Burger BBQ', description: 'Hamburguesa con bacon, queso cheddar y salsa BBQ', priceEur: 10.00, imageUrl: 'https://images.unsplash.com/photo-1553979459-d2229ba7433b?w=600&h=400&fit=crop&q=80', allergenIds: [1, 3, 7, 10, 12] },
    { categoryName: 'Principales', name: 'Burger Vegana', description: 'Hamburguesa de garbanzos con aguacate', priceEur: 9.00, imageUrl: 'https://images.unsplash.com/photo-1520072959219-c595e6cdc07a?w=600&h=400&fit=crop&q=80', allergenIds: [1, 6] },
    { categoryName: 'Principales', name: 'Patatas fritas', description: 'Patatas fritas caseras con sal', priceEur: 3.50, imageUrl: 'https://images.unsplash.com/photo-1573080496219-bb080dd4f877?w=600&h=400&fit=crop&q=80', allergenIds: [] },
    { categoryName: 'Bebidas', name: 'Coca-Cola', description: 'Coca-Cola 33cl', priceEur: 2.00, imageUrl: 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=600&h=400&fit=crop&q=80', allergenIds: [] },
    { categoryName: 'Bebidas', name: 'Agua mineral', description: 'Agua mineral 50cl', priceEur: 1.50, imageUrl: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=600&h=400&fit=crop&q=80', allergenIds: [] },
    { categoryName: 'Bebidas', name: 'Cerveza artesana', description: 'Cerveza artesana local 33cl', priceEur: 3.00, imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=600&h=400&fit=crop&q=80', allergenIds: [1] },
    { categoryName: 'Postres', name: 'Brownie de chocolate', description: 'Brownie casero con nueces', priceEur: 4.00, imageUrl: 'https://images.unsplash.com/photo-1607920591413-4ec007e70023?w=600&h=400&fit=crop&q=80', allergenIds: [1, 3, 7, 8] },
  ],
  1: [ // Casa Tradición
    { categoryName: 'Entrantes', name: 'Salmorejo cordobés', description: 'Salmorejo tradicional con jamón y huevo', priceEur: 6.00, imageUrl: 'https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?w=600&h=400&fit=crop&q=80', allergenIds: [1, 3] },
    { categoryName: 'Entrantes', name: 'Ensalada mixta', description: 'Ensalada fresca con tomate, lechuga y aceitunas', priceEur: 5.50, imageUrl: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=600&h=400&fit=crop&q=80', allergenIds: [12] },
    { categoryName: 'Principales', name: 'Paella mixta', description: 'Paella de mariscos y pollo para 2 personas', priceEur: 12.00, imageUrl: 'https://images.unsplash.com/photo-1534080564583-6be75777b70a?w=600&h=400&fit=crop&q=80', allergenIds: [2, 4, 14] },
    { categoryName: 'Principales', name: 'Rabo de toro', description: 'Rabo de toro estofado con verduras', priceEur: 14.00, imageUrl: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&h=400&fit=crop&q=80', allergenIds: [9, 12] },
    { categoryName: 'Principales', name: 'Flamenquín cordobés', description: 'Flamenquín de jamón y queso', priceEur: 9.50, imageUrl: 'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?w=600&h=400&fit=crop&q=80', allergenIds: [1, 3, 7] },
    { categoryName: 'Principales', name: 'Pescaíto frito', description: 'Variado de pescado frito al estilo andaluz', priceEur: 11.00, imageUrl: 'https://images.unsplash.com/photo-1580476262798-bddd9f4b7369?w=600&h=400&fit=crop&q=80', allergenIds: [1, 4] },
    { categoryName: 'Bebidas', name: 'Tinto de verano', description: 'Tinto de verano con limón', priceEur: 2.50, imageUrl: 'https://images.unsplash.com/photo-1558642452-9d2a7deb7f62?w=600&h=400&fit=crop&q=80', allergenIds: [12] },
    { categoryName: 'Bebidas', name: 'Zumo de naranja', description: 'Zumo de naranja natural', priceEur: 3.00, imageUrl: 'https://images.unsplash.com/photo-1613478223719-2ab802602423?w=600&h=400&fit=crop&q=80', allergenIds: [] },
    { categoryName: 'Postres', name: 'Torrijas', description: 'Torrijas caseras con miel', priceEur: 4.50, imageUrl: 'https://images.unsplash.com/photo-1484723091739-30a097e8f929?w=600&h=400&fit=crop&q=80', allergenIds: [1, 3, 7] },
    { categoryName: 'Postres', name: 'Flan de huevo', description: 'Flan casero con caramelo', priceEur: 3.50, imageUrl: 'https://images.unsplash.com/photo-1528975604071-b4dc52a2d18c?w=600&h=400&fit=crop&q=80', allergenIds: [3, 7] },
  ],
  2: [ // Pizzería Forn Nou
    { categoryName: 'Entrantes', name: 'Bruschetta', description: 'Pan tostado con tomate, albahaca y aceite', priceEur: 5.00, imageUrl: 'https://images.unsplash.com/photo-1572695157366-5e585ab2b69f?w=600&h=400&fit=crop&q=80', allergenIds: [1] },
    { categoryName: 'Entrantes', name: 'Ensalada César', description: 'Ensalada con pollo, parmesano y croutons', priceEur: 7.00, imageUrl: 'https://images.unsplash.com/photo-1550304943-4f24f54ddde9?w=600&h=400&fit=crop&q=80', allergenIds: [1, 3, 4, 7] },
    { categoryName: 'Principales', name: 'Pizza Margarita', description: 'Tomate, mozzarella y albahaca', priceEur: 9.00, imageUrl: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=600&h=400&fit=crop&q=80', allergenIds: [1, 7] },
    { categoryName: 'Principales', name: 'Pizza Pepperoni', description: 'Tomate, mozzarella y pepperoni', priceEur: 10.50, imageUrl: 'https://images.unsplash.com/photo-1628840042765-356cda07504e?w=600&h=400&fit=crop&q=80', allergenIds: [1, 7] },
    { categoryName: 'Principales', name: 'Pizza 4 Quesos', description: 'Mozzarella, gorgonzola, parmesano y emmental', priceEur: 11.00, imageUrl: 'https://images.unsplash.com/photo-1571407970349-bc81e7e96d47?w=600&h=400&fit=crop&q=80', allergenIds: [1, 7] },
    { categoryName: 'Principales', name: 'Pizza Vegetal', description: 'Tomate, mozzarella, pimientos, champiñones y aceitunas', priceEur: 9.50, imageUrl: 'https://images.unsplash.com/photo-1511689660979-10d2b1aada49?w=600&h=400&fit=crop&q=80', allergenIds: [1, 7] },
    { categoryName: 'Principales', name: 'Calzone', description: 'Masa rellena de jamón, queso y champiñones', priceEur: 10.00, imageUrl: 'https://images.unsplash.com/photo-1536964549204-cce9eab227bd?w=600&h=400&fit=crop&q=80', allergenIds: [1, 3, 7] },
    { categoryName: 'Bebidas', name: 'Refresco', description: 'Refresco a elegir 33cl', priceEur: 2.00, imageUrl: 'https://images.unsplash.com/photo-1581636625402-29b2a704ef13?w=600&h=400&fit=crop&q=80', allergenIds: [] },
    { categoryName: 'Bebidas', name: 'Cerveza italiana', description: 'Peroni Nastro Azzurro 33cl', priceEur: 3.50, imageUrl: 'https://images.unsplash.com/photo-1608270586620-248524c67de9?w=600&h=400&fit=crop&q=80', allergenIds: [1] },
    { categoryName: 'Postres', name: 'Tiramisú', description: 'Tiramisú casero con mascarpone', priceEur: 5.00, imageUrl: 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=600&h=400&fit=crop&q=80', allergenIds: [1, 3, 7] },
    { categoryName: 'Postres', name: 'Panna cotta', description: 'Panna cotta con frutos rojos', priceEur: 4.50, imageUrl: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=600&h=400&fit=crop&q=80', allergenIds: [7] },
  ],
  3: [ // Pollos El Rincón
    { categoryName: 'Entrantes', name: 'Alitas de pollo', description: 'Alitas de pollo crujientes con salsa', priceEur: 5.00, imageUrl: 'https://images.unsplash.com/photo-1527477396000-e27163b4bbed?w=600&h=400&fit=crop&q=80', allergenIds: [1, 3] },
    { categoryName: 'Entrantes', name: 'Croquetas de pollo', description: 'Croquetas caseras de pollo', priceEur: 4.50, imageUrl: 'https://images.unsplash.com/photo-1554520735-0a6b8b6ce8b7?w=600&h=400&fit=crop&q=80', allergenIds: [1, 3, 7] },
    { categoryName: 'Principales', name: 'Pollo asado entero', description: 'Pollo asado al horno con patatas', priceEur: 12.00, imageUrl: 'https://images.unsplash.com/photo-1598103442097-8b74394b95c6?w=600&h=400&fit=crop&q=80', allergenIds: [] },
    { categoryName: 'Principales', name: 'Medio pollo asado', description: 'Medio pollo asado con ensalada', priceEur: 7.00, imageUrl: 'https://images.unsplash.com/photo-1594221708779-94832f4320d1?w=600&h=400&fit=crop&q=80', allergenIds: [] },
    { categoryName: 'Principales', name: 'Pollo al limón', description: 'Pechuga de pollo al limón con arroz', priceEur: 8.50, imageUrl: 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=600&h=400&fit=crop&q=80', allergenIds: [] },
    { categoryName: 'Principales', name: 'Nuggets de pollo', description: '12 nuggets de pollo con patatas', priceEur: 6.50, imageUrl: 'https://images.unsplash.com/photo-1562967914-608f82629710?w=600&h=400&fit=crop&q=80', allergenIds: [1, 3] },
    { categoryName: 'Bebidas', name: 'Coca-Cola', description: 'Coca-Cola 33cl', priceEur: 1.80, imageUrl: 'https://images.unsplash.com/photo-1629203851122-3726ecdf080e?w=600&h=400&fit=crop&q=80', allergenIds: [] },
    { categoryName: 'Bebidas', name: 'Agua', description: 'Agua mineral 50cl', priceEur: 1.20, imageUrl: 'https://images.unsplash.com/photo-1564419320461-6870880221ad?w=600&h=400&fit=crop&q=80', allergenIds: [] },
    { categoryName: 'Postres', name: 'Helado de vainilla', description: 'Tarrina de helado de vainilla', priceEur: 3.00, imageUrl: 'https://images.unsplash.com/photo-1570197788417-0e82375c9371?w=600&h=400&fit=crop&q=80', allergenIds: [3, 7] },
    { categoryName: 'Postres', name: 'Natillas', description: 'Natillas caseras', priceEur: 2.50, imageUrl: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=600&h=400&fit=crop&q=80', allergenIds: [3, 7] },
  ],
  4: [ // Kebab Alhambra
    { categoryName: 'Entrantes', name: 'Hummus', description: 'Hummus casero con pan de pita', priceEur: 4.50, imageUrl: 'https://images.unsplash.com/photo-1637949385162-e416fb15b2eb?w=600&h=400&fit=crop&q=80', allergenIds: [11] },
    { categoryName: 'Entrantes', name: 'Falafel (6 uds)', description: 'Falafel de garbanzos con salsa tahini', priceEur: 5.00, imageUrl: 'https://images.unsplash.com/photo-1593001874117-c99c800e3eb7?w=600&h=400&fit=crop&q=80', allergenIds: [1, 11] },
    { categoryName: 'Principales', name: 'Kebab de pollo', description: 'Kebab de pollo con verduras y salsa yogur', priceEur: 6.50, imageUrl: 'https://images.unsplash.com/photo-1561651188-d207bbec4ec3?w=600&h=400&fit=crop&q=80', allergenIds: [1, 7] },
    { categoryName: 'Principales', name: 'Kebab mixto', description: 'Kebab de pollo y ternera con ensalada', priceEur: 7.50, imageUrl: 'https://images.unsplash.com/photo-1529006557810-274b9b2fc783?w=600&h=400&fit=crop&q=80', allergenIds: [1, 7] },
    { categoryName: 'Principales', name: 'Durum de falafel', description: 'Wrap de falafel con verduras y tahini', priceEur: 6.00, imageUrl: 'https://images.unsplash.com/photo-1626700051175-6818013e1d4f?w=600&h=400&fit=crop&q=80', allergenIds: [1, 11] },
    { categoryName: 'Principales', name: 'Plato kebab', description: 'Plato de kebab con arroz, ensalada y salsas', priceEur: 9.00, imageUrl: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=600&h=400&fit=crop&q=80', allergenIds: [1, 7] },
    { categoryName: 'Principales', name: 'Shawarma de ternera', description: 'Shawarma de ternera con patatas', priceEur: 8.00, imageUrl: 'https://images.unsplash.com/photo-1633321702518-7fecdafb94d5?w=600&h=400&fit=crop&q=80', allergenIds: [1, 7] },
    { categoryName: 'Bebidas', name: 'Ayran', description: 'Bebida de yogur tradicional', priceEur: 2.00, imageUrl: 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?w=600&h=400&fit=crop&q=80', allergenIds: [7] },
    { categoryName: 'Bebidas', name: 'Té moruno', description: 'Té verde con hierbabuena', priceEur: 2.50, imageUrl: 'https://images.unsplash.com/photo-1571934811356-5cc061b6821f?w=600&h=400&fit=crop&q=80', allergenIds: [] },
    { categoryName: 'Postres', name: 'Baklava', description: 'Pastel de hojaldre con pistachos y miel', priceEur: 3.50, imageUrl: 'https://images.unsplash.com/photo-1519676867240-f03562e64571?w=600&h=400&fit=crop&q=80', allergenIds: [1, 8] },
    { categoryName: 'Postres', name: 'Kunafa', description: 'Postre de queso con fideos kataifi', priceEur: 4.00, imageUrl: 'https://images.unsplash.com/photo-1579888944880-d98341245702?w=600&h=400&fit=crop&q=80', allergenIds: [1, 7, 8] },
  ],
};
