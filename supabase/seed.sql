...
('prod-rest-001-00', 'cat-rest-001-0', 'Nachos con queso',      'Nachos crujientes con queso cheddar fundido',                5.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-001-01', 'cat-rest-001-0', 'Aros de cebolla',       'Aros de cebolla rebozados y crujientes',                     4.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-001-02', 'cat-rest-001-1', 'Burger Clásica',        'Hamburguesa de ternera con lechuga, tomate y cebolla',        8.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-001-03', 'cat-rest-001-1', 'Burger BBQ',            'Hamburguesa con bacon, queso cheddar y salsa BBQ',           10.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-001-04', 'cat-rest-001-1', 'Burger Vegana',         'Hamburguesa de garbanzos con aguacate',                       9.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-001-05', 'cat-rest-001-1', 'Patatas fritas',        'Patatas fritas caseras con sal',                              3.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-001-06', 'cat-rest-001-2', 'Coca-Cola',             'Coca-Cola 33cl',                                              2.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-001-07', 'cat-rest-001-2', 'Agua mineral',          'Agua mineral 50cl',                                           1.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-001-08', 'cat-rest-001-2', 'Cerveza artesana',      'Cerveza artesana local 33cl',                                 3.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-001-09', 'cat-rest-001-3', 'Brownie de chocolate',  'Brownie casero con nueces',                                   4.00, '/placeholder-product.jpg', true, now(), now()),
-- Restaurant 2: Casa Tradición (10 products)
('prod-rest-002-00', 'cat-rest-002-0', 'Salmorejo cordobés',    'Salmorejo tradicional con jamón y huevo',                     6.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-002-01', 'cat-rest-002-0', 'Ensalada mixta',        'Ensalada fresca con tomate, lechuga y aceitunas',             5.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-002-02', 'cat-rest-002-1', 'Paella mixta',          'Paella de mariscos y pollo para 2 personas',                 12.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-002-03', 'cat-rest-002-1', 'Rabo de toro',          'Rabo de toro estofado con verduras',                         14.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-002-04', 'cat-rest-002-1', 'Flamenquín cordobés',   'Flamenquín de jamón y queso',                                 9.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-002-05', 'cat-rest-002-1', 'Pescaíto frito',        'Variado de pescado frito al estilo andaluz',                 11.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-002-06', 'cat-rest-002-2', 'Tinto de verano',       'Tinto de verano con limón',                                   2.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-002-07', 'cat-rest-002-2', 'Zumo de naranja',       'Zumo de naranja natural',                                     3.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-002-08', 'cat-rest-002-3', 'Torrijas',              'Torrijas caseras con miel',                                    4.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-002-09', 'cat-rest-002-3', 'Flan de huevo',         'Flan casero con caramelo',                                    3.50, '/placeholder-product.jpg', true, now(), now()),
-- Restaurant 3: Pizzería Forn Nou (11 products)
('prod-rest-003-00', 'cat-rest-003-0', 'Bruschetta',            'Pan tostado con tomate, albahaca y aceite',                   5.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-003-01', 'cat-rest-003-0', 'Ensalada César',        'Ensalada con pollo, parmesano y croutons',                    7.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-003-02', 'cat-rest-003-1', 'Pizza Margarita',       'Tomate, mozzarella y albahaca',                               9.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-003-03', 'cat-rest-003-1', 'Pizza Pepperoni',       'Tomate, mozzarella y pepperoni',                             10.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-003-04', 'cat-rest-003-1', 'Pizza 4 Quesos',        'Mozzarella, gorgonzola, parmesano y emmental',               11.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-003-05', 'cat-rest-003-1', 'Pizza Vegetal',         'Tomate, mozzarella, pimientos, champiñones y aceitunas',       9.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-003-06', 'cat-rest-003-1', 'Calzone',              'Masa rellena de jamón, queso y champiñones',                  10.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-003-07', 'cat-rest-003-2', 'Refresco',             'Refresco a elegir 33cl',                                      2.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-003-08', 'cat-rest-003-2', 'Cerveza italiana',     'Peroni Nastro Azzurro 33cl',                                  3.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-003-09', 'cat-rest-003-3', 'Tiramisú',             'Tiramisú casero con mascarpone',                              5.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-003-10', 'cat-rest-003-3', 'Panna cotta',          'Panna cotta con frutos rojos',                                4.50, '/placeholder-product.jpg', true, now(), now()),
-- Restaurant 4: Pollos El Rincón (10 products)
('prod-rest-004-00', 'cat-rest-004-0', 'Alitas de pollo',       'Alitas de pollo crujientes con salsa',                        5.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-004-01', 'cat-rest-004-0', 'Croquetas de pollo',    'Croquetas caseras de pollo',                                  4.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-004-02', 'cat-rest-004-1', 'Pollo asado entero',    'Pollo asado al horno con patatas',                           12.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-004-03', 'cat-rest-004-1', 'Medio pollo asado',     'Medio pollo asado con ensalada',                              7.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-004-04', 'cat-rest-004-1', 'Pollo al limón',        'Pechuga de pollo al limón con arroz',                         8.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-004-05', 'cat-rest-004-1', 'Nuggets de pollo',      '12 nuggets de pollo con patatas',                             6.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-004-06', 'cat-rest-004-2', 'Coca-Cola',             'Coca-Cola 33cl',                                              1.80, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-004-07', 'cat-rest-004-2', 'Agua',                  'Agua mineral 50cl',                                           1.20, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-004-08', 'cat-rest-004-3', 'Helado de vainilla',    'Tarrina de helado de vainilla',                               3.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-004-09', 'cat-rest-004-3', 'Natillas',              'Natillas caseras',                                            2.50, '/placeholder-product.jpg', true, now(), now()),
-- Restaurant 5: Kebab Alhambra (11 products)
('prod-rest-005-00', 'cat-rest-005-0', 'Hummus',                'Hummus casero con pan de pita',                               4.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-005-01', 'cat-rest-005-0', 'Falafel (6 uds)',       'Falafel de garbanzos con salsa tahini',                       5.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-005-02', 'cat-rest-005-1', 'Kebab de pollo',        'Kebab de pollo con verduras y salsa yogur',                   6.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-005-03', 'cat-rest-005-1', 'Kebab mixto',           'Kebab de pollo y ternera con ensalada',                       7.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-005-04', 'cat-rest-005-1', 'Durum de falafel',      'Wrap de falafel con verduras y tahini',                       6.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-005-05', 'cat-rest-005-1', 'Plato kebab',           'Plato de kebab con arroz, ensalada y salsas',                 9.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-005-06', 'cat-rest-005-1', 'Shawarma de ternera',   'Shawarma de ternera con patatas',                             8.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-005-07', 'cat-rest-005-2', 'Ayran',                 'Bebida de yogur tradicional',                                 2.00, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-005-08', 'cat-rest-005-2', 'Té moruno',             'Té verde con hierbabuena',                                    2.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-005-09', 'cat-rest-005-3', 'Baklava',               'Pastel de hojaldre con pistachos y miel',                     3.50, '/placeholder-product.jpg', true, now(), now()),
('prod-rest-005-10', 'cat-rest-005-3', 'Kunafa',                'Postre de queso con fideos kataifi',                          4.00, '/placeholder-product.jpg', true, now(), now());
